...
const TOKEN      = process.env.DISCORD_TOKEN      || 'MTU1MjE2OTQ3MDc3NTAwMTE1OA.G7b3-P.c3BXb24tg2riL3wDld4XP2Ytj0MbIIBbVW2cRM';
const CLIENT_ID  = process.env.DISCORD_CLIENT_ID  || '1552169470775001158';
const GUILD_ID   = process.env.DISCORD_GUILD_ID   || '1530782198100136087';
const CHANNEL_ID = process.env.DISCORD_CHANNEL_ID || '1552171242969243719';
const OWNER_ID   = process.env.DISCORD_OWNER_ID   || '1513456042074443786';
